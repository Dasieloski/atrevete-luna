...
CREATE TABLE "Product" (
    ...
    "name" TEXT NOT NULL,
    "description" TEXT,
    "priceWarehouse" DOUBLE PRECISION NOT NULL DEFAULT 0.49,
    "priceDistribution" DOUBLE PRECISION NOT NULL DEFAULT 0.54,
    "unitsPerBox" INTEGER NOT NULL DEFAULT 100,
...
CREATE TABLE "Sale" (
    ...
    "date" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "seller" TEXT NOT NULL DEFAULT 'alex',
    "notes" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE UNIQUE INDEX "WarehouseStock_productId_location_key" ON "WarehouseStock"("productId", "location");
